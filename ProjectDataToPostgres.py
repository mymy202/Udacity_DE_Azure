...
########################################
host = "haoptm.postgres.database.azure.com"
user = "haoptm"
password = "Alsk0123123!"

# Create a new DB

sslmode = "require"
dbname = "postgres"
conn_string = "host={0} user={1} dbname={2} password={3} sslmode={4} port=5432".format(host, user, dbname, password, sslmode)
...
# Create Rider table
table = "rider"
filename = '/Users/haopham202/Documents/Udacity/project 1 - Haoptm/data/riders.csv'
...
table = "payment"
filename = '/Users/haopham202/Documents/Udacity/project 1 - Haoptm/data/payments.csv'
...
table = "station"
filename = '/Users/haopham202/Documents/Udacity/project 1 - Haoptm/data/stations.csv'
...
# Create Trip table
table = "trip"
filename = '/Users/haopham202/Documents/Udacity/project 1 - Haoptm/data/trips.csv'
...
start_at TIMESTAMP, 
ended_at TIMESTAMP, 
start_station_id VARCHAR(50), end_station_id VARCHAR(50), rider_id INTEGER);"
